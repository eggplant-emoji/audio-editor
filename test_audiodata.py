...
def test_duration_is_correctly_calculated():
    actual = one_frame_per_second.duration()
    assert actual == 4000


def test_speedup_should_decrease_duration_by_2_times():
    error = 1500
...
def test_speedup_should_decrease_duration_by_3_times():
    error = 1500
...
def test_slowdown_should_increase_duration_by_2_times():
    error = 1500
    expected = audiodata1.duration() * 2
...
def test_slowdown_should_increase_duration_by_3_times():
    error = 1500
    expected = audiodata1.duration() * 3
